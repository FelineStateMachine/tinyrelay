...
var templateCatalog = []Template{
	...
	{Name: "social", Title: "Social", About: "A chronological social feed for members' notes, comments, reactions, long-form articles and podcasts. Members write; anyone reads.", Policy: map[string]any{"writes": "allowlist", "reads": "open", "directoryPublic": true}, AllowKinds: []int{0, 1, 5, 6, 7, 54, 1111, 30023, 10054, 10064, 10154}, Connections: []string{"notes", "blog"}},
