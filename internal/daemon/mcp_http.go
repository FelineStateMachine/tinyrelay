...
func (t *Tenant) llmsHTTP(w http.ResponseWriter, r *http.Request) {
	...
	lines = append(lines,
		...
		"- Read tools: list_repositories, read_repository, list_issues, read_issue, list_pull_requests, read_pull_request, list_files, read_file, read_status, read_management, list_rooms, read_room, read_thread, list_wiki, read_wiki_page, read_merge_request, list_agents, list_jobs and read_job.",
