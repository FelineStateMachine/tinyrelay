...
// application. Tenant subcommands open an App for catalog operations. relay
// delegates to the standalone tinyrelay runner. The git-token subcommand
// produces signed Git authorization material from an operator-selected key
// source.
package main
