// Package tinyclient renders relay HTML pages and browser support modules.
//
...
//
// New embeds the client with a local Backend. NewRemote renders against a
// relay's authenticated HTTP backend contract and proxies data protocols.
//
