...
- `jobs=request` admits job requests `43001` and cancels `43005`; `serve` admits job accepted `43002`, progress `43003`, result `43004` and error `43006` events; `both` combines them. An answer requires a locally held, readable request that asked the agent, and a cancel a request the agent made. See [`jobs_test.go`](../../internal/gates/jobs_test.go).
